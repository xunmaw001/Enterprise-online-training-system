    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                JiangshiEntity jiangshi = jiangshiService.selectById(forum.getJiangshiId());
                if(jiangshi != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setJiangshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("jiangshi_id", forum.getJiangshiId())
...
//                            forumEntity.setForumName(data.get(0));                    //话题标题 要改的
//                            forumEntity.setYonghuId(Integer.valueOf(data.get(0)));   //员工 要改的
//                            forumEntity.setJiangshiId(Integer.valueOf(data.get(0)));   //讲师 要改的
...
//                            forumEntity.setForumStateTypes(Integer.valueOf(data.get(0)));   //话题状态 要改的
