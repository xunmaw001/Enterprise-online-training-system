    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(exampaper !=null){
            ...
            BeanUtils.copyProperties( exampaper , view );//把实体数据重构到view中
                ...
                //级联表
                JiangshiEntity jiangshi = jiangshiService.selectById(exampaper.getJiangshiId());
                if(jiangshi != null){
    ...
    */
    ...
    public R save(@RequestBody ExampaperEntity exampaper, HttpServletRequest request){
        ...
        if(false)
            ...
            exampaper.setJiangshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<ExampaperEntity> queryWrapper = new EntityWrapper<ExampaperEntity>()
            .eq("jiangshi_id", exampaper.getJiangshiId())
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ExampaperEntity exampaperEntity = new ExampaperEntity();
//                            exampaperEntity.setJiangshiId(Integer.valueOf(data.get(0)));   //讲师 要改的
