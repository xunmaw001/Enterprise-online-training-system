...
public class ExamrewrongquestionView extends ExamrewrongquestionEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		//级联表 exampaper
			...
			* 试卷表 的 讲师
			*/
			private Integer exampaperJiangshiId;
			/**
			* 试卷名称
			*/
		...
		try {
			...
			e.printStackTrace();
				...
				//级联表的get和set exampaper
					...
					* 获取：试卷表 的 讲师
					*/
					public Integer getExampaperJiangshiId() {
						return exampaperJiangshiId;
					}
					/**
					* 设置：试卷表 的 讲师
					*/
					public void setExampaperJiangshiId(Integer exampaperJiangshiId) {
						this.exampaperJiangshiId = exampaperJiangshiId;
					}
