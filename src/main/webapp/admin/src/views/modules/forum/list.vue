            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.jiangshiId">
                            讲师
                        </span>
...
|| (sessionTable == 'jiangshi' && scope.row.jiangshiId ==userId)
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '话题标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.forumName" placeholder="话题标题" clearable></el-input>
                     </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '员工名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.yonghuName" placeholder="员工名称" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/qiyezaixianpeixun/upload/forumMuBan.xls"
                        >批量导入话题讨论数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.jiangshiId = el.jiangshiId;//---
                            forum.jiangshiName = el.jiangshiName;
                            forum.jiangshiPhone = el.jiangshiPhone;
                            forum.jiangshiPhoto = el.jiangshiPhoto;
                            forum.jiangshiEmail = el.jiangshiEmail;
                            forum.createTime = el.createTime;
