    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="员工名称" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="员工名称" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="员工名称" prop="yonghuName">
                           <el-input v-model="ruleForm.yonghuName"
