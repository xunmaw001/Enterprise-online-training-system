<template>
    <div style="backgroundImage: url('/qiyezaixianpeixun/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">企业在线培训系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="讲师名称" class="input" v-if="tableName=='jiangshi'">
                            <el-input v-model="ruleForm.jiangshiName" autocomplete="off" placeholder="讲师名称"  />
                        </el-form-item>
                        <el-form-item label="联系方式" class="input" v-if="tableName=='jiangshi'">
                            <el-input v-model="ruleForm.jiangshiPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='jiangshi'">
                            <el-input v-model="ruleForm.jiangshiEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
                        <el-form-item label="员工名称" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="员工名称"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.jiangshiName)&& 'jiangshi'==this.tableName){
                                this.$message.error('讲师名称不能为空');
                                return
                            }
                             if('jiangshi' == this.tableName && this.ruleForm.jiangshiPhone&&(!this.$validate.isMobile(this.ruleForm.jiangshiPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('jiangshi' == this.tableName && this.ruleForm.jiangshiEmail&&(!this.$validate.isEmail(this.ruleForm.jiangshiEmail))){
